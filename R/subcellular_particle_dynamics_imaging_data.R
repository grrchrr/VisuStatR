...
#' @description Loads example images of subcellular particle dynamics of labeled genomic loci in engineered cell line. Correspoinding to tracking data: \code{\link{subcellular_particle_dynamics}}
